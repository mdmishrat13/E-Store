            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="flex items-center">
                <span className="inline-block w-8 h-8 overflow-hidden rounded-full">
                  {avatar.length?(<Image src={avatar} alt="avatar" width={12} height={12}/>
                  ):(<RxAvatar className="w-8 h-8 rounded-full" />)}
                </span>
                <label
                  htmlFor="profileImg"
                  className="ml-5 flex items-center justify-center border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
                >
                  <span className="py-2 px-4 cursor-pointer">Upload an image</span>
                  <input type="file" name="password" id="profileImg" className="sr-only" required />
                </label>
              </div>
              ...
              <button
                type="submit"
                className="w-full font-medium text-white bg-gray-900 rounded-lg text-sm px-5 py-2.5 text-center"
              >
                Sign in
              </button>
